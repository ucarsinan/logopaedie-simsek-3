...
export const tr: Translations = {
  ...
  career_page: {
    ...
    application_sub: "İlk iletişim için adın ve sana ulaşabileceğimiz bir iletişim bilgisi yeterlidir; CV gerekli değildir.",
    application_primary_cta: "Bağlayıcı olmayan iletişim kur",
    application_whatsapp_cta: "Başvurular için WhatsApp",
    application_call_cta: "Şimdi ara",
    application_email_cta: "E-posta yaz",
