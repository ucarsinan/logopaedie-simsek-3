...
export const tr: Translations = {
  ...
  header: {
    location: "Duisburg'da dil ve konuşma terapisi",
  ...
  footer: {
    tagline: "Duisburg'da dil ve konuşma terapisi",
    nav_label: "Alt menü",
    links: {
      services: { label: "Terapi alanları", href: "/terapi/" },
      tuerkische: {
  ...
  team_page: {
    ...
    career_text:
      "Duisburg'daki ekibimiz için dil ve konuşma terapistleri arıyoruz; iş deneyimi gerekli değildir.",
    job_link: "İş ilanı",
  ...
  career_page: {
    schema: {
      ...
      job_benefits:
        "Beş günlük haftada 30 gün izin, 24 ve 31 Aralık tatil, yıllık Noel ikramiyesi, mali ve zaman açısından eğitim desteği, yapılandırılmış işe alışma süreci, özel kullanıma açık iPad, mümkünse otopark, aksi halde park ücreti desteği",
      qualifications:
        "Eğitim veya üniversite yoluyla alınmış, devlet tarafından tanınan ve çalışma izni bulunan logopedi ya da dil ve konuşma terapisi yeterliliği; çok iyi Almanca",
      skills:
        "Pediatri, nöroloji, kekemelik, hızlı konuşma, ses, artikülasyon veya diğer alanlarda uzmanlıklar memnuniyetle karşılanır ve işe başladıktan sonra geliştirilebilir",
      responsibilities:
        "Her yaştan kişiye değerlendirme ve terapi; dokümantasyon, raporlar, ebeveyn ve yakını danışmanlığı ile organizasyon. Ev ziyaretleri yalnızca çalışanın kendi isteğiyle mümkündür.",
      employer_overview:
        "Praxis für Logopädie Şimşek, Duisburg'da dört kişilik ekip, yatay hiyerarşi, haftalık deneyim paylaşımı ve yapılandırılmış işe alışma süreci sunar.",
    },
    ...
    hero_subtitle:
      "Duisburg-Mitte'deki ekibimiz için süresiz pozisyonlarda çalışacak dil ve konuşma terapistleri (m/w/d) arıyoruz.",
    apply_now: "Hemen başvurun",
    expectations_label: "Beklentilerimiz",
    profile_heading: "Profiliniz",
    requirements: [
      "Devlet tarafından tanınan ve çalışma izni bulunan logopedi veya dil ve konuşma terapisi eğitimi ya da üniversite mezuniyeti",
      "Çok iyi Almanca bilgisi",
      "Terapi ve randevu planlamasını bağımsız yürütmeye ilgi",
      "Diğer diller ve mesleki ilgi alanları memnuniyetle karşılanır, ancak şart değildir",
    ],
    welcome: "Mesleğe yeni başlayanlar özellikle memnuniyetle karşılanır.",
    ...
    benefits: [
      ...
      { title: "Esnek çalışma modelleri", desc: "38,5 saat tam zamanlı, değişken yarı zamanlı ve dört günlük hafta mümkün." },
      { title: "Kendi planlaman", desc: "Randevu, mola ve boşlukları güven esasına göre kendin planlarsın; düzenli fazla mesai ile hafta sonu ve resmî tatil çalışması öngörülmemektedir; istisnalar telafi edilir." },
      { title: "iPad ve terapi materyali", desc: "iPrax ve gerekli yazılımlarla iPad; özel kullanım da mümkün; ayrıca gerekli terapi materyalleri sağlanır." },
      { title: "Otopark ve ikram", desc: "Mümkünse otopark, aksi halde park ücreti desteği; ücretsiz atıştırmalıklar, içecekler ve mutfak." },
    ],
    ...
    application_sub: "Üç alan yeterli; CV isteğe bağlıdır. Telefon, e-posta veya posta yoluyla da iletişime geçebilirsin.",
    ...
    form: {
      ...
      mail_submit: "E-posta hazırlayın",
      mail_hint: "Düğme, e-posta uygulamanızda bir taslak açar. Başvurunuzu göndermek için e-postayı oradan göndermeniz gerekir.",
      sending: "Gönderiliyor …",
      success_title: "Başvurunuz için teşekkürler!",
      success_text: "Teşekkürler! Seninle kişisel olarak iletişime geçeceğiz.",
      error_text: "Maalesef gönderilemedi. Lütfen tekrar deneyin veya doğrudan info@logopaedie-simsek.de adresine yazın.",
      privacy_before: "Bilgilerinizi başvurunuzu değerlendirmek için işleriz. Ayrıntılar:",
      privacy_link: "Gizlilik politikası",
    },
    mail_subject: "Tanışma talebi – Dil ve konuşma terapisi",
    mail_body:
      "Merhaba Şimşek-Uçar Hanım,\n\nMuayenehanenizdeki bir pozisyonla ilgileniyorum ve sizi ve ekibinizi bağlayıcı olmayan bir şekilde tanımak isterim.\n\nSelamlar\n",
  },
  hero: {
    ...
    cta_secondary: "Hizmetleri inceleyin",
    badge_station: "Duisburg Hbf'ye 2 dk.",
  ...
  about: {
    ...
    description:
      "Dil ve konuşma terapisti <strong>Emel Şimşek-Uçar</strong> yönetimindeki modern muayenehanemizde; erken çocukluktan yaşlılığa kadar tüm yaş gruplarına kapsamlı değerlendirme, danışmanlık ve terapi hizmeti sunulmaktadır.",
    stat_bilingual: "Almanca ve Türkçe iki dilli hizmet",
    stat_areas_value: "Tüm",
    stat_areas: "Tüm yaş grupları için terapi alanları",
    stat_station: "Duisburg Hbf'ye",
  ...
  services: {
    ...
    overview: "Tüm terapi alanları",
    items: [
      {
        title: "Dil bozuklukları",
        text: "Dil anlama ve ifade alanındaki güçlüklerin değerlendirilmesi ve terapisi – dil gelişimindeki gecikmelerden inme sonrası gelişen afaziye kadar, çocuklar ve yetişkinler için.",
        tags: ["Dil gelişimi", "Afazi", "Erken destek"],
        href: "/terapi/dil-bozuklugu/",
      },
      {
        title: "Konuşma bozuklukları",
        text: "Konuşma sesi, akıcılık ve motor konuşma alanındaki güçlüklerde terapi desteği. Kekemelik, takifemi / dağınık hızlı konuşma, artikülasyon güçlükleri veya dizartri durumlarında yanınızdayız.",
        tags: [
          "Dizartri",
          "Kekemelik",
          "Konuşma sesi",
      ...
      },
      {
        ...
        text: "Fonksiyonel ve organik ses bozukluklarında terapi desteği. En önemli iletişim araçlarınızdan biri olan sesinizi daha sağlıklı kullanmanızı destekliyoruz.",
        tags: ["Disfoni", "Ses", "Fonksiyonel ses"],
        href: "/terapi/ses-terapisi/",
      },
      {
        title: "Yutma bozuklukları (Disfaji)",
        text: "Yetişkinlerde ve çocuklarda yutma bozukluklarının değerlendirilmesi ve terapisi – güvenli beslenmeyi desteklemek, yaşam kalitesini korumak ve olası riskleri azaltmak için.",
  ...
  praxis: {
    section_label: "Konum ve muayenehane",
    heading: "Duisburg merkezinde modern muayenehane",
    description:
      "Yüksek kaliteli terapi materyalleriyle donatılmış, çocuklara özel oyun alanlarına sahip, toplu taşımaya kolayca erişilebilen aydınlık terapi odaları.",
    address_label: "Adres",
    ...
    transit_value: "Duisburg Hbf'ye 2 dakika yürüme mesafesinde",
    transit_sub: "Bölge treni, metro, otobüs – hepsi yakında",
    feature_rooms: "Modern, aydınlık terapi odaları",
  ...
  faq: {
    ...
    items: [
      {
        q: "Dil ve konuşma terapistleri hangi alanlarda destek verir?",
        a: "Dil ve konuşma terapistleri; dil (örn. gelişimsel/özgül dil bozukluğu, afazi), konuşma (örn. kekemelik, konuşma sesi bozuklukları, dizartri), ses (örn. kısıklık, disfoni) ve yutma (disfaji) alanlarındaki güçlüklerde değerlendirme ve terapi desteği sunar. Çocuklar, yetişkinler ve yaşlılar terapi alabilir.",
      },
      {
        q: "Çocuğum dil ve konuşma terapistine ne yaşında gidebilir?",
        a: "Dil ve konuşma terapisi bebeklik döneminden itibaren uygulanabilir. Erken değerlendirme uygun desteğin planlanmasına yardımcı olur. Okul öncesi dönemde uygun destek özellikle önemlidir.",
      },
      {
        q: "Dil ve konuşma terapisi için reçete gerekli mi?",
        a: "Sigorta kapsamındaki terapi için aile hekiminizden veya uzman hekiminizden Heilmittelverordnung (doktorun verdiği terapi reçetesi / tedavi reçetesi) almanız gerekir. Kendiniz ödeme yapmak isterseniz reçetesiz de randevu için arayabilirsiniz.",
      },
      {
        q: "Sağlık sigortası dil ve konuşma terapisi masraflarını karşılar mı?",
        a: "Almanya'daki genel/yasal sağlık sigortası (GKV), geçerli terapi reçetesiyle terapi masraflarının büyük bölümünü karşılar. Genellikle tedavi ücretinin %10'u ve reçete başına 10 € katkı payı ödenir. Yasal ve özel sağlık sigortalarıyla çalışıyoruz.",
      },
      {
        q: "İlk seans nasıl geçer?",
        a: "İlk seansta kapsamlı bir anamnez alır ve standart değerlendirme araçlarıyla mevcut terapi ihtiyacını değerlendiririz. Bu seans yaklaşık 60 dakika sürer. Birlikte terapi hedefleri belirler ve bireysel terapi planını oluştururuz.",
      },
      {
        q: "Bir seans ne kadar sürer?",
        a: "Standart bir terapi seansı 45 dakika sürer. İlk seansta (değerlendirme ve anamnez) biraz daha fazla zaman ayrılır. Terapi sürecinin toplam uzunluğu bozukluğun türüne ve bireysel ilerlemeye göre değişir; düzenli olarak yeniden değerlendirilir.",
      },
      {
      ...
      },
      {
        ...
        a: "Evet – Almanca ve Türkçe olarak kapsamlı değerlendirme, danışmanlık ve terapi hizmeti sunuyoruz. Özellikle iki dilli büyüyen çocuklar ve Türkçe konuşan yetişkinler için bu yaklaşım terapi sürecini kolaylaştırır. Duisburg'da bu hizmet oldukça nadirdir.",
      },
      {
  ...
  kontakt: {
    ...
    phone_cta_heading: "Randevu için arayın",
    phone_cta_sub:
    ...
    info_address_sub: "3. kat · Asansör mevcut · Duisburg Hbf'ye 2 dk.",
    info_lang_label: "Diller",
    info_lang_value: "Almanca & Türkçe",
    info_lang_sub: "Her iki dilde terapi sunuyoruz",
    insurance_note:
      "<strong>Sigorta kapsamı mı, masrafı kendiniz mi karşılayacaksınız?</strong><br>Almanya'daki genel/yasal sağlık sigortası (GKV) ve özel sağlık sigortalarıyla çalışıyoruz. Masrafı kendisi karşılamak isteyen hastaları da kabul ediyoruz. Ödeme ve sigorta konusundaki sorularınızı yanıtlamaktan memnuniyet duyarız.",
  },
  cookie: {
  ...
  schema: {
    ...
    founder_title: "Dil ve konuşma terapisti",
